<div id="main" class="container">
    ...
    <div class="user-flex">
        ...
        if (isset($_SESSION['dangnhap'])) {
            ...
            $sql = "SELECT * FROM nguoidung WHERE user_id = $user_id1";
            $query = mysqli_query($conn, $sql);
            $count = mysqli_num_rows($query);
            if ($count > 0) {
                $row = mysqli_fetch_assoc($query);
                ...
                <form action="pages/xulyuser-profile.php?user-id=<?php echo $user_id ?>" method="post">
                    ...
                    <div class="user-input">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <div class="hottt" style="color: red; font-size: 20px;">*</div>
                    ...
                    <input class="user-submit" name="update-address" type="submit" value="Cập nhật">
                </form>
            </div>
