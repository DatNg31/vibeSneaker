...
if(isset($_POST['logup']))
{
    ...
    if($email_exists > 0) {
        ...
        $sql = "INSERT INTO nguoidung (ten, email, matkhau, sodienthoai) VALUES ('$first_name $last_name', '$email', '$pass', '$phone')";
...
<main>
    <div class="container">
        <div class="form" style="width: 30%; margin-top:50px">
            ...
            <form action="" method="post" class="form-logup" name="frm" onsubmit="return thongbao(this)">
                <h2>Đăng Ký</h2>
